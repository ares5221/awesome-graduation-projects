...
IF Order<>Empty And ID<>Empty Then
	...
	IF Order="up" Then
		...
		End IF
			...
			Tw("<Script>window.location='P_manages.asp?Page="&Request("Page")&"&ClassNameID="&Request("ClassNameID")&"&ParentClassID="&ParentClassID&"&key="&key&"&Type_Class="&Type_Class&"'</Script>")
	ElseIF Order="dowm" Then
		...
		conn.execute ("update Products set P_X="&B1_Order("P_X")&" where ID="&ID&"")
		conn.execute ("update Products set P_X="&B_b&" where ID="&B1_Order("ID")&"")
		Tw("<Script>window.location='P_manages.asp?Page="&Request("Page")&"&ClassNameID="&ClassNameID&"&ParentClassID="&ParentClassID&"&key="&key&"&Type_Class="&Type_Class&"'</Script>")
	End IF
End IF
'***************************************************************************************************
        ...
        <td colspan="2"><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
            <tr class="table_bg_n">
			  ...
			  <table border=0 cellpadding="5" cellspacing="0">
			    <tr>
				<td class="b_t"><strong><a href="P_manages.asp">所有产品</a></strong></td>
				<%
    ...
    <td height="130" valign="top" style="padding-top:10px;">
      <table width="85%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="table_border">
        <tr bgcolor="#DBE6FF">
          <td colspan="2" class="padding_1"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table_bg">
              <tr>
                <td align="center" class="table_bg_size">产品管理</td>
              </tr>
          </table></td>
        </tr>
        <tr bgcolor="#DBE6FF">
          <td colspan="2"><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
              <form name="form1" method="post" action="P_Del.asp?Action=Del" style="margin:0px ">
		   ...
		   %>
              <tr class="table_bg_n">
                ...
                <td align="center"><a href="p_Modify.asp?ID=<%=Rspro("ID")%>">编辑</a></td>
              </tr>
		  <%
		  	Rspro.MoveNext
		  ...
		  %>
              <tr class="table_bg_n">
                ...
                <td colspan="6" class="padding-left-10"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="18%" align="center"><input type="submit" name="Submit" value="删除选中产品"></td>
    ...
    <td height="130"><form name="form2" method="post" action="?" onSubmit="return keya(this)">
      <table width="85%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="table_border">
        <tr bgcolor="#DBE6FF">
          <td colspan="2" class="padding_1"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table_bg">
              <tr>
                <td align="center" class="table_bg_size"> 查找产品</td>
              </tr>
          </table></td>
        </tr>
        <tr bgcolor="#DBE6FF">
          <td colspan="2"><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
              <tr class="table_bg_n">
                <td height="25" align="center">产品名称：
