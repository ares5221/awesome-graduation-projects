...
<p align="left">&nbsp;<img border="0" src="images/gb_site.gif"><a href="index.jsp?id=<%=rs.getString("id")%>"><font color="#004F75">返回主页</font></a></td>
</tr>
</table>
</center>
</div>
...
<img border="0" src="images/product.gif"><!-- #EndEditable --></TD></TR>
<tr>
<TD vAlign=top width="84%" height=20 bgcolor="#FFFFFF"></TD>
</tr>
<TR>
<TD vAlign=top width="84%" height=127>
...
<TBODY>
<TR>
<TD class=M><B><IMG align=absMiddle src="images/i.gif" width=18>产品展示</B>
</TD>
<TD align=right></TD>
</TR>
</TBODY>
...
<%
rs=stmt.executeQuery("SELECT * from showbar where memid='"+memid+"' order by id desc");
...
<a href=../../show/show.jsp?id=<%=rs.getString("id")%> target="_blank"><img alt="点击查看原始尺寸" src="../../<%=rs.getString("showphoto")%>" width="80" height="80" border=0></a></TD>
<TD vAlign=top><img border="0" src="images/14.gif"><SPAN class=m><B><font color="#ff6600"><a href="../../show/show.jsp?id=<%=rs.getString("id")%>"><font color="#FF6600"><%=rs.getString("showname")%></font></a></font><a href="javascript:show_sader(&quot;show_product.jsp?id=&quot;)"> 
</A></B></SPAN><BR><B>产品型号：<%=rs.getString("showxing")%></B><br><B>产品产地：<%=rs.getString("showaddress")%></B><br>(<a href="../../show/show.jsp?id=<%=rs.getString("id")%>"><font color="#ff6600">详细信息</font></a>)<BR></TD>
</TR>
...
<%
rs=stmt.executeQuery("SELECT count(*) from showbar where memid='"+memid+"' order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="spzs.jsp?page=<%=j%>&id=<%=memid%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
