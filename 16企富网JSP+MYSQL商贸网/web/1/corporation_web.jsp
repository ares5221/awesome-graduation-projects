...
<TR>
<TD> <a href="corporation_web.jsp?id=<%=rs.getString("id")%>" onClick="MM_nbGroup('down','group1','bt1','images/bt1.gif',1)" onMouseOut="MM_nbGroup('out')" onMouseOver="MM_nbGroup('over','bt1','images/bt2.gif','images/bt2.gif',1);MM_nbGroup('over','bt1','images/bt11.gif','images/bt11.gif',1)"> 
<img border="0" src="images/bt1.gif" width="144" height="29" name="bt1" alt="公司简介"></a></TD>
</TR>
<TR>
<TD> <a href="spzs.jsp?id=<%=rs.getString("id")%>" onClick="MM_nbGroup('down','group1','bt2','images/bt2.gif',1)" onMouseOut="MM_nbGroup('out')" onMouseOver="MM_nbGroup('over','bt2','images/bt21.gif','images/bt21.gif',1)"> 
<img border="0" src="images/bt2.gif" width="144" height="29" name="bt2" alt="产品介绍"></a></TD>
</TR>
<TR>
<TD> <a href="syjh.jsp?id=<%=rs.getString("id")%>" onClick="MM_nbGroup('down','group1','bt3','images/bt3.gif',1)" onMouseOut="MM_nbGroup('out')" onMouseOver="MM_nbGroup('over','bt3','images/bt31.gif','images/bt31.gif',1)"> 
<img border="0" src="images/bt3.gif" width="144" height="32" name="bt3" alt="供求信息"></a></TD>
</TR>
<TR>
<TD> <a href="job.jsp?id=<%=rs.getString("id")%>" onClick="MM_nbGroup('down','group1','bt4','images/bt4.gif',1)" onMouseOut="MM_nbGroup('out')" onMouseOver="MM_nbGroup('over','bt4','images/bt41.gif','images/bt41.gif',1)"> 
<img border="0" src="images/bt4.gif" name="bt4" alt="招聘信息"></a></TD>
</TR>
<TR>
<TD> <a href="contact.jsp?id=<%=rs.getString("id")%>" onClick="MM_nbGroup('down','group1','bt5','images/bt5.gif',1)" onMouseOut="MM_nbGroup('out')" onMouseOver="MM_nbGroup('over','bt5','images/bt51.gif','images/bt51.gif',1)"> 
...
class=css>&nbsp; </SPAN><%=rs.getString("qyjj")%><BR></TD> 
</TR></TBODY></TABLE>
</div>
</TD></TR>
<TR>
