...
<a href="../../job/list.jsp?id=<%=rs.getString("id")%>" target="_blank"><%=rs.getString("topic")%></a></span></b>&nbsp;&nbsp;<font color="#fc9603">&nbsp;&nbsp; 【<%=rs.getString("fbtime")%>】</font></TD>
</TR>
<TR height="30"> 
<TD><a href="../../job/list.jsp?id=<%=rs.getString("id")%>" target="_blank">[<font color="#FF6600">详细信息</font>]</a></TD> 
</TR> 
...
</table></TD></TR></TABLE><font color="#000000">总共</font><font color="#FF0000"><%=i%></font><font color="#000000">条信息</font> 
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="job.jsp?page=<%=j%>&id=<%=memid%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页</td>
</tr>
</table>
</center>
</div>
