...
<a href="../../sj/sjxx.jsp?id=<%=rs.getString("id")%>" target="_blank"><%=rs.getString("topic")%></a></span></b>&nbsp;&nbsp;<%=rs.getString("fbtime")%><font color="#fc9603">&nbsp;&nbsp; 
                              ...
                              <%if(Integer.parseInt((String)rs.getString("lei"))==2){%><%if (rs.getString("fast").compareTo("1")==0){out.print("<font color=red>[紧急]</font>");}%>[求购信息]<%}%>
...
<TR height="30"> 
<TD><a href="../../sj/sjxx.jsp?id=<%=rs.getString("id")%>" target="_blank">[<font color="#FF6600">详细信息</font>]</a></TD> 
</TR> 
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="syjh.jsp?page=<%=j%>&id=<%=memid%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
