...
<TABLE cellSpacing=0 cellPadding=0 width=750 align=center border=0>
  ...
  <TR>
    <TD style="PADDING-LEFT: 20px" bgColor=#ff8000 colSpan=2 height=28><IMG 
      ...
      color=#ffffff size=4><b>合作专区</b></FONT></TD></TR>
  <TR>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          ...
          background=../images/top_bj006c.jpg><IMG 
            height=16 src="../images/i_my4.gif" 
            width=64></TD>
...
<td  height=25  width="30">&nbsp;</td><td width="180"> <div align="left"><a href="../sj/sjindex2.jsp?dfl=<%=rs.getString("dfl")%>&lei=4"  target="_blank"><font color=000000 size=3><b><%=rs.getString("dfl")%></b></font></a>


<iframe frameborder=0 leftmargin=0 marginheight=0 marginwidth=0 scrolling=no src=total.jsp?lei=4&dfl=<%=rs.getString("dfl")%> topmargin=0 width=50 height=15></iframe>

<br>
<iframe frameborder=0 leftmargin=0 marginheight=0 marginwidth=0 scrolling=no src=sfl.jsp?lei=4&dfl=<%=rs.getString("dfl")%> topmargin=0 width=150 height=34></iframe>
<br><br>
...
<TABLE cellSpacing=0 cellPadding=0 width="390" align=center border=0>
        <TBODY>
        <TR>
          <TD><embed src="../images/ban.swf" quality=high 
            ...
            border=0>
              ...
              <TR>
                <TD vAlign=center bgColor=#f1f2db height=22>&nbsp; <IMG 
                  ...
                  width=16>&nbsp;<STRONG>最新合作信息</STRONG></TD></TR></TBODY></TABLE>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center 
            border=0>
              <TBODY>
              <TR>
...
<iframe frameborder=0 leftmargin=0 marginheight=0 marginwidth=0 scrolling=no src=right.jsp?lei=4 topmargin=0 width=380 height=873></iframe>
