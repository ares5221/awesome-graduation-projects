...
<TABLE cellSpacing=0 cellPadding=0 width=750 align=center border=0>
  ...
  <TR>
    <TD style="PADDING-LEFT: 20px" bgColor=#ff8000 colSpan=2 height=28><IMG 
      ...
      color=#ffffff size=4><b><%if (request.getParameter("baar")==null){%>供应专区<%}else{%>我要采购<%}%></b></FONT></TD></TR>
  <TR>
...
<td  height=25  width="30">&nbsp;</td><td width="180"> <div align="left"><a href="../sj/sjindex2.jsp?dfl=<%=rs.getString("dfl")%>&lei=1"  target="_blank"><font color=000000 size=3><b><%=rs.getString("dfl")%></b></font></a>


<iframe frameborder=0 leftmargin=0 marginheight=0 marginwidth=0 scrolling=no src=total.jsp?lei=1&dfl=<%=rs.getString("dfl")%> topmargin=0 width=50 height=15></iframe>

<br>
<iframe frameborder=0 leftmargin=0 marginheight=0 marginwidth=0 scrolling=no src=sfl.jsp?lei=1&dfl=<%=rs.getString("dfl")%> topmargin=0 width=150 height=34></iframe>
<br><br>
...
</TD><TD vAlign=top width=400 bgColor=#ffffff>
...
<TABLE cellSpacing=0 cellPadding=0 width="390" align=center border=0>
        <TBODY>
        <TR>
          <TD><embed src="../images/index.swf" quality=high 
            ...
            border=0>
              ...
              <TR>
                <TD vAlign=center bgColor=#f1f2db height=22>&nbsp; <IMG 
                  ...
                  width=16>&nbsp;<STRONG>最新供应信息</STRONG></TD></TR></TBODY></TABLE>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center 
            border=0>
              <TBODY>
              <TR>
...
<iframe frameborder=0 leftmargin=0 marginheight=0 marginwidth=0 scrolling=no src=right.jsp?lei=1 topmargin=0 width=380 height=780></iframe>
