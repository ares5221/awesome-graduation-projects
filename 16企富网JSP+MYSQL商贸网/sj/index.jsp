...
<td  height=25  width="30">&nbsp;</td><td width="180"> <div align="left"><a href="../sj/sjindex2.jsp?dfl=<%=rs.getString("dfl")%>&lei=0"  target="_blank"><font color=000000 size=3><b><%=rs.getString("dfl")%></b></font></a>


<iframe frameborder=0 leftmargin=0 marginheight=0 marginwidth=0 scrolling=no src=total.jsp?lei=0&dfl=<%=rs.getString("dfl")%> topmargin=0 width=50 height=15></iframe>

<br>
<iframe frameborder=0 leftmargin=0 marginheight=0 marginwidth=0 scrolling=no src=sfl.jsp?dfl=<%=rs.getString("dfl")%> topmargin=0 width=150 height=65></iframe>
<br><br>
