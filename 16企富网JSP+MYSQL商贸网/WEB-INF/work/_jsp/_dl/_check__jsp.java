...
con.close();
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_check__jsp.java", "foo");
    _caucho_line_map.add("/DL/../conn/conn.jsp", 6, 32);
    _caucho_line_map.add("/DL/check.jsp", 3, 44);
    _caucho_line_map.add(32, 70);
    _caucho_line_map.add(42, 78);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("DL/check.jsp"), "izTwHZRgQ2C5EChEfKq86Q==", false);
    _caucho_depends.add(depend);
