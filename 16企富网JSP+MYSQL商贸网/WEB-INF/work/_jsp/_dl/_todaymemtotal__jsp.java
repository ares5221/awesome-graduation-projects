...
public class _todaymemtotal__jsp extends com.caucho.jsp.JavaPage{
...
while(rs.next()) i = rs.getInt(1) ;
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_todaymemtotal__jsp.java", "foo");
    _caucho_line_map.add("/DL/../conn/conn.jsp", 6, 34);
    _caucho_line_map.add("/DL/../conn/time.jsp", 6, 46);
    _caucho_line_map.add(9, 50);
    _caucho_line_map.add("/DL/todaymemtotal.jsp", 4, 52);
    _caucho_line_map.add(6, 54);
    _caucho_line_map.add(10, 59);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("DL/todaymemtotal.jsp"), "uFCNzLR2H7kl/uaspPgsWg==", false);
    _caucho_depends.add(depend);
