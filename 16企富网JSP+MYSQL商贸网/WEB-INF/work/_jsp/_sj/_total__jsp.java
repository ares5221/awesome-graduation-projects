...
public class _total__jsp extends com.caucho.jsp.JavaPage{
...
while(rs.next()) i = rs.getInt(1) ;
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_total__jsp.java", "foo");
    _caucho_line_map.add("/sj/../conn/conn.jsp", 6, 32);
    _caucho_line_map.add("/sj/total.jsp", 4, 44);
    _caucho_line_map.add(14, 55);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("sj/total.jsp"), "nM48G/FHOUn3JeuNHkwNBg==", false);
    _caucho_depends.add(depend);
