...
public class _indexsj__jsp extends com.caucho.jsp.JavaPage{
...
i++ ;
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_indexsj__jsp.java", "foo");
    _caucho_line_map.add("/sj/../conn/conn.jsp", 6, 32);
    _caucho_line_map.add("/sj/indexsj.jsp", 7, 44);
    _caucho_line_map.add(15, 49);
    _caucho_line_map.add(15, 51);
    _caucho_line_map.add(17, 53);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("sj/indexsj.jsp"), "cimicZU9WljkdncXbHAqSA==", false);
    _caucho_depends.add(depend);
