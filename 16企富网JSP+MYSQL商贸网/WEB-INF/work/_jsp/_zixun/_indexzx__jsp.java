...
public class _indexzx__jsp extends com.caucho.jsp.JavaPage{
...
i++ ;
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_indexzx__jsp.java", "foo");
    _caucho_line_map.add("/zixun/../conn/conn.jsp", 6, 32);
    _caucho_line_map.add("/zixun/indexzx.jsp", 7, 44);
    _caucho_line_map.add(17, 50);
    _caucho_line_map.add(17, 52);
    _caucho_line_map.add(19, 54);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("zixun/indexzx.jsp"), "FoEmHUe3KvUO0oYhXera6Q==", false);
    _caucho_depends.add(depend);
