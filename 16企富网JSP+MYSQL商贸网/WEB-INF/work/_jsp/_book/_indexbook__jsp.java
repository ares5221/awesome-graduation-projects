...
public class _indexbook__jsp extends com.caucho.jsp.JavaPage{
...
i++ ;
    ...
    throws javax.servlet.ServletException
  {
    ...
    _caucho_line_map = new com.caucho.java.LineMap("_indexbook__jsp.java", "foo");
    _caucho_line_map.add("/book/../conn/conn.jsp", 6, 32);
    _caucho_line_map.add("/book/indexbook.jsp", 7, 44);
    _caucho_line_map.add(20, 54);
    _caucho_line_map.add(20, 56);
    _caucho_line_map.add(22, 58);
    com.caucho.vfs.Depend depend;
    depend = new com.caucho.vfs.Depend(appDir.lookup("book/indexbook.jsp"), "M5pZTF5EKoEWEYQYcv1CTg==", false);
    _caucho_depends.add(depend);
