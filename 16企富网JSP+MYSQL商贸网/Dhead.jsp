...
<HTML>
<TITLE><%=webname%>----全国地区联盟站点<%=(String) session.getAttribute("dldq")%>站</TITLE>
<HEAD>
...
<TABLE cellSpacing=0 cellPadding=0 width=750 border=0 background="../images/v6_top_bg.gif" align=center>
  <TBODY>
  <TR>
    <TD width=270 rowSpan=2 background=../images/Dlogo.gif align=right height=65><br><br><br><font  class=nav color=browse><b><%=(String) session.getAttribute("dldq")%></b>站</font>&nbsp;<br></TD>
