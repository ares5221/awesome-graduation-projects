...
rs=stmt.executeQuery("SELECT * from sjxx where memid='"+userid+"' order by id desc");
...
<%
rs=stmt.executeQuery("SELECT count(*) from sjxx where memid='"+userid+"' order by id desc");
