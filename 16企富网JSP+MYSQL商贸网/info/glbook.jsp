...
<td class="zl"><strong><font color="#1F69A0">查看我的话题</font></strong>
</td>
<td align=right><a href=../book/addbook.jsp><font color=red>马上发布</font></a></td>
</tr>
</table></td>
</tr>
<tr> 
                                                              ...
                                                              <td height="18" valign="top"> 
                                                                  ...
                                                                  <table width="521" border="0" cellpadding="3" cellspacing="1" bgcolor="A8A8A9">
                                                                    <tr bgcolor="EAECED" class="zl"> 
                                                                      <td width="50" bgcolor="EAECED"><div align="center"><strong><font color="#333333">属性</font></strong></div></td>
                                                                      <td width="191"><div align="center"><strong><font color="#333333">发表标题</font></strong></div></td>
...
rs=stmt.executeQuery("SELECT * from book where fbmemid='"+userid+"' order by id desc");
...
%>
                                                                    ...
                                                                    <tr bgcolor="#FFFFFF"> <td class="zl"><div align="center"><%if(Integer.parseInt((String)rs.getString("ForR"))==0){%><font color=red>主题</font><%}else{%><font color=cccccc>回复</font><%}%></div></td>
                                                                      <td class="zl"> 
                                                                        <div align="center">
<%if(Integer.parseInt((String)rs.getString("ForR"))==0){%>
<a href="../book/read.jsp?id=<%=rs.getString("id")%>" class="zllink">
<%}else{%>
<a href="../book/read.jsp?id=<%=rs.getString("topicid")%>" class="zllink">
<%}%>
...
<td class="zl"> 
                                                                        <div align="center"><font color="#333333"><%if(Integer.parseInt((String)rs.getString("ForR"))==0){%><%=rs.getString("readnum")%><%}else{%>-<%}%></font></div></td>
<td class="zl"> 
                                                                        <div align="center"><font color="#333333"><%if(Integer.parseInt((String)rs.getString("ForR"))==0){%><%=rs.getString("replynum")%><%}else{%>-<%}%></font></div></td>
...
<%
rs=stmt.executeQuery("SELECT count(*) from book where fbmemid='"+userid+"' order by id desc");
