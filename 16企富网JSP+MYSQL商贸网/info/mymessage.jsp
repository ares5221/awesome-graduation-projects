...
<td class="zl"><strong><font color="#1F69A0">查看我的留言</font></strong>
</td>
</tr>
</table></td>
</tr>
...
rs=stmt.executeQuery("SELECT * from message where recemem='"+userid+"' order by id desc");
...
<%
rs=stmt.executeQuery("SELECT count(*) from message where recemem='"+userid+"'  order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="mymessage.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
