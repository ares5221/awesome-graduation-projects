...
<td class="zl"><strong><font color="#1F69A0">管理产品展示</font></strong>
</td>
</tr>
</table></td>
</tr>
                                                              ...
                                                              <td height="18" valign="top"> 
                                                                  ...
                                                                  <table width="521" border="0" cellpadding="3" cellspacing="1" bgcolor="A8A8A9">
                                                                    <tr bgcolor="EAECED" class="zl"> 
                                                                      ...
                                                                      <td width="191"><div align="center"><strong><font color="#333333">展&nbsp;示&nbsp;产&nbsp;品&nbsp;名&nbsp;称</font></strong></div></td>
...
rs=stmt.executeQuery("SELECT * from showbar where memid='"+userid+"' order by id desc");
...
%>
                                                                    ...
                                                                    <tr bgcolor="#FFFFFF"> 
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="../../show/show.jsp?id=<%=rs.getString("id")%>" target="_blank" class="zllink"><font color="#333333">
...
<%=rs.getString("showname")%>
                                                                      ...
                                                                      <td class="zl"><div align="center"><a href="xgshow.jsp?id=<%=rs.getString("id")%>" class="zllink"><font color="#333333">修改</font></a></div></td>
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="delshow.jsp?id=<%=rs.getString("id")%>" class="zllink"><font color="#333333">删除</font></a></div></td>
                                                                    </tr>
...
<%
rs=stmt.executeQuery("SELECT count(*) from showbar where memid='"+userid+"' order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="glshow.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
