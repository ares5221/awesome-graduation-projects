                                                    ...
                                                    <tr> 
                                                      <td><div align="center"> 
                                                          <table width="500" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr> 
                                                              <td><form  action="oksj.jsp" method="post" name="form1"  onSubmit="return check1();">
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                          <tr> 
                                                                            ...
                                                                            <td width="28"> <SCRIPT src="images/func.js"></SCRIPT>
                                                                              <input type="radio" name="lei" value="2" onclick="turnit('code_area770')"></td>
...
<TR id=code_area770 style="DISPLAY: none">
 <td width="18%" height="35" bgcolor="#FFFFFF"> 
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
<input name="fast" type="radio" value="0"><a href="#" class="zllink"><font color="444A4F">普通求购</font></a>&nbsp; 
<input name="fast" type="radio" value="1" checked><a href="#" class="zllink"><font color="red">紧急求购</font></a></td></TR>                          
