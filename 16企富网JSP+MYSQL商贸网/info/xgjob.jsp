                                                    ...
                                                    <tr> 
                                                      <td><div align="center"> 
                                                          <table width="500" border="0" cellspacing="0" cellpadding="0">
                                                            <tr> 
                                                              <td height="24" bgcolor="E4E6E7"><table width="500" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr> 
                                                                    ...
                                                                    <td class="zl"><strong><font color="#1F69A0">发布招骋信息</font></strong></td>
                                                                  </tr>
                                                                </table></td>
                                                            </tr>
                                                            <tr> 
                                                            ...
                                                            <tr> 
                                                              <td><form  action="xgjobok.jsp" method="post" name="form1"  onSubmit="return check1();">
                                                                  <table width="500" border="0" cellpadding="3" cellspacing="1" bgcolor="A8A8A9">
                                                                    <tr bgcolor="EAECED"> 
                                                                      <td height="35" colspan="3"> 
                                                                        <div align="center"> 
                                                                          <p class="zl2"><font color="3C3E3F">请填写招骋信息详情</font></p>
                                                                        </div></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr> 
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
                                                                        <input name="jobnum" type="text" class="zl" id="jobnum" size="20"  value=<%=rs.getString("jobnum")%>></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr> 
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
                                                                        <input name="jobaddress" type="text" class="zl" id="jobaddress" size="20" value=<%=rs.getString("jobaddress")%>></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr> 
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
                                                                        <select size="1" name="lei" class="f11">

<option value="<%=rs.getString("lei")%>">招骋<%=rs.getString("lei")%></option>
<option value="全职">招聘全职</option>
<option value="兼职">招聘兼职</option>
<option value="应届生">招聘应届毕业生</option>
</select></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr> 
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
                                                                      <textarea rows="8" cols="54" name="content" class="f11" style="font-family: 宋体"><%=rs.getString("content")%></textarea></td>
                                                                    </tr>
...
<input name="fbmem" type="hidden" class="zl" id="company" size="28"   value="<%=rs.getString("myname")%>">
<input name="fbmemcompany" type="hidden" class="zl" id="fbmemcompany" size="28"   value="<%=rs.getString("fbmemcompany")%>">
<input name="fbmemid" type="hidden" class="zl" id="fbmemid" size="28"   value="<%=rs.getString("fbmemid")%>">
...
<!--
  function check1(){
    ...
    if (ff.jobnum.value==""){
      window.alert("请填写招骋人数！")
      ff.jobnum.focus()
      return false
    }
    
    if (ff.jobaddress.value==""){
      window.alert("请填写工作地点！")
      ff.jobaddress.focus()
      return false
    }    
