                                                    ...
                                                    <tr> 
                                                      <td><div align="center"> 
                                                          <table width="500" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr> 
                                                              <td><form  action="okshow.jsp" method="post" name="form1"  onSubmit="return check1();">
...
<option value="其他">其他</option>
                                                                    ...
                                                                    <tr> 
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
                                                                        <input name="showname" type="text" class="zl" id="showname" size="30"></td>
                                                                    </tr>
                                                                                                                               <tr> 
                                                                      <td width="18%" height="35" bgcolor="#FFFFFF"> 
                                                                        <div align="center"><a href="#" class="zllink"><font color="444A4F">产品型号</font></a>:<FONT color=red size=2>*</FONT></div></td>
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
                                                                        <input name="showxing" type="text" class="zl" id="showxing" size="30"></td>
                                                                    </tr>
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
                                                                        <input name="showaddress" type="text" class="zl" id="showaddress" size="30"></td>
                                                                    </tr>
...
<option selected>请从下拉框中选择产品图片</option>
<%
...
<input name="company" type="hidden" class="zl" id="company" size="28"   value="<%=rs.getString("qymc")%>">
<input name="memid" type="hidden" class="zl" id="memid" size="28"   value="<%=rs.getString("id")%>">
...
window.alert("请填写产品型号！")
    ...
    if (ff.showphoto.value==""){
      window.alert("请选择产品图片！如果下拉框中无图片选择,请点击左边'管理我的图片'上传!")
      ff.showphoto.focus()
      return false
    }
