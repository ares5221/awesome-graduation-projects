...
<div align=center>
                                                            ...
                                                            <tr> 
                                                              <td height="24" bgcolor="E4E6E7"><table width="500" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr> 
                                                                    ...
                                                                    <td class="zl"><strong><font color="#1F69A0">发布广告</font></strong></td>
                                                                  </tr>
                                                                </table></td>
                                                            </tr>
                                                            <tr> 
 ...
 <input name=lei type="hidden" class="zl" id="lei" size="60" value=1>
 ...
 <input name=topic type="text" class="zl" id="topic" size="60"></td>
                ...
                <tr> 
                                                                      <td width="18%" height="35" bgcolor="#FFFFFF"> 
                                                                        <div align="center"><a href="#" class="zllink"><font color="444A4F">广告简短内容</font></a>:<FONT color=red size=2>*</FONT></div></td>
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
