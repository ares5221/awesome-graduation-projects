                                                            ...
                                                            <tr> 
                                                              <td height="24" bgcolor="E4E6E7"><table width="500" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr> 
                                                                    ...
                                                                    <td class="zl"><strong><font color="#1F69A0">发布地区资讯</font></strong></td>
                                                                  </tr>
                                                                </table></td>
                                                            </tr>
                                                            <tr> 
                                                                  ...
                                                                  <table width="500" border="0" cellpadding="3" cellspacing="1" bgcolor="A8A8A9">
                                                                    <tr bgcolor="EAECED"> 
                                                                      <td height="35" colspan="3"> 
                                                                        <div align="center"> 
                                                                          <p class="zl2"><font color="3C3E3F">发布地区资讯</font></p>
                                                                        </div></td>
                                                                    </tr>
...
<textarea class=f11 rows="25" name="content" cols="50"></textarea></td>
                                                                    </tr>
