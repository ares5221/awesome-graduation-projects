...
<td class="zl"><strong><font color="#1F69A0">企富通会员</font></strong>
</td>
</tr>
</table></td>
</tr>
...
<td width="50" bgcolor="EAECED"><div align="center"><strong><font color="#333333">TO</font></strong></div></td>
                                                                      <td width="51" bgcolor="EAECED"><div align="center"><strong><font color="#333333">冻结</font></strong></div></td>
</tr>
...
rs=stmt.executeQuery("SELECT * from qyml where yue=1 and comeon=1 and vip=1 and frocen=0  and dlid='"+dlid+"'  order by id desc");
...
<%=rs.getString("qymc")%>
                                                                      ...
                                                                      <td class="zl"><div align="center"><a href="to.jsp?id=<%=rs.getString("id")%>&yue=1&vip=0&comeon=0&frocen=0" class="zllink"><font color="#333333">普通</font></a></div></td>
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="to.jsp?id=<%=rs.getString("id")%>&yue=1&vip=0&comeon=0&frocen=1" class="zllink"><font color="#333333">冻结</font></a></div></td>
                                                                    </tr>
...
<%
rs=stmt.executeQuery("SELECT count(*) from qyml where yue=1 and comeon=1 and vip=1 and frocen=0  and dlid='"+dlid+"'  order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="qftmem.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
