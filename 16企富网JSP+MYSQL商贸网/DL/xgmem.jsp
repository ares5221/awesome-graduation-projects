                                                    ...
                                                    <tr> 
                                                      <td><div align="center"> 
                                                          <table width="500" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr> 
                                                              <td><form  action="xgmemok.jsp" method="post" name="Form1"  >
...
%>
 ...
 <input name=username type="text" class="zl" id="username" size="30" readonly=true value=<%=rs.getString("username")%>></td>
                                                                    </tr>
                                                      ...
                                                      <tr> 
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
                                                                        <textarea class=f11 rows="8" name="qyjj" cols="40"><%=rs.getString("qyjj")%></textarea></td>
                                                                    </tr>
...
<%}else{%>
<script language=JavaScript>{window.alert('无权操作!');window.location.href='indexdl.jsp'}</script>
<%
}
%>