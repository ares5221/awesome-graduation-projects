<%if ((String) session.getAttribute("dlname")==null){response.sendRedirect("../dl");}%>
<%@ page import="com.ntsky.file.*,java.util.*"%>
<%@ page import="java.io.*" %>
<%@ page import="java.sql.*" %>
<%@ include file="../conn/conn.jsp"%>
<%@ include file="../info/phototime.jsp"%>

<%
String phototime=(String) session.getAttribute("time");
String pname=(String) session.getAttribute("dlname")+phototime;%>
...
<%
	...
	// 文件目录
	param.setFileDir("dl/uploadphoto");
	// 文件名
...
String sql="update dqjie set photoname='"+photoname+"'  where dlid='"+dlid+"'";
stmt.executeUpdate(sql);
response.sendRedirect("dqjie.jsp");
%>
