...
<td class="zl"><strong><font color="#1F69A0">普通使用会员</font></strong>
</td>
</tr>
</table></td>
</tr>
...
rs=stmt.executeQuery("SELECT * from qyml where yue=1 and vip=0 and frocen=0  and dlid='"+dlid+"'  order by id desc");
...
<%=rs.getString("qymc")%>
                                                                      ...
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="to.jsp?id=<%=rs.getString("id")%>&yue=1&comeon=0&vip=0&frocen=1" class="zllink"><font color="#333333">冻结</font></a></div></td>
                                                                    </tr>
...
<%
rs=stmt.executeQuery("SELECT count(*) from qyml where yue=1 and vip=0 and frocen=0  and dlid='"+dlid+"'   order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="ptmem.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
