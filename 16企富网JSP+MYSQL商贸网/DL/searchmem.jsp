...
rs=stmt.executeQuery("SELECT * from qyml where (username like '%"+txt+"%' or qymc like '%"+txt+"%') and dlid='"+dlid+"' order by id desc");
...
<%
rs=stmt.executeQuery("SELECT count(*) from qyml where  (username like '%"+txt+"%' or qymc like '%"+txt+"%') and dlid='"+dlid+"' order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="searchmem.jsp?page=<%=j%>&txt=<%=txt%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
