        ...
        <TR>
          ...
          height=154>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              <TBODY>
              <TR>
                <TD class=C vAlign=top align=left><font color=browse><%=(String) session.getAttribute("dldq")%>分站管理员</font>:<STRONG><%=(String) session.getAttribute("dlname")%></STRONG> 
                  先生，您好！</TD></TR>
...
%>
                                                                    ...
                                                                    <tr bgcolor="#FFFFFF"> 
                                                                      <td class="zl"> 
                                                                        <div align="center">
<a href=showmsg.jsp?id=<%=rs.getString("id")%>><%=rs.getString("mtopic")%></a>
