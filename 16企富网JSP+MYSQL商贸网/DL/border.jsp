...
<td class="zl"><strong><font color="#1F69A0">管理广告频道</font></strong>
</td><td align=right><a href=addborder.jsp>发布广告</font></td>
</tr>
</table></td>
</tr>
<tr> 
...
rs=stmt.executeQuery("SELECT * from dqzixun where dlid='"+dlid+"' and lei=1 order by id desc");
...
%>
                                                                    ...
                                                                    <tr bgcolor="#FFFFFF"> 
                                                                      ...
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="<%=rs.getString("url")%>" title="<%=rs.getString("content")%>" target="_blank" class="zllink"><font color="#333333">
<%=rs.getString("topic")%>
</font></a></div></td>
...
<%
rs=stmt.executeQuery("SELECT count(*) from dqzixun where dlid='"+dlid+"'  and lei=1  order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="border.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
