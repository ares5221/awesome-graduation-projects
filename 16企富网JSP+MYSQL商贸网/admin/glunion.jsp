...
<td class="zl"><strong><font color="#1F69A0">管理网站登录</font></strong>
</td>
</tr>
</table></td>
</tr>
...
<td height="18">&nbsp;</td>
                                                            ...
                                                            <tr> 
                                                             ...
                                                             <td width="70" bgcolor="EAECED"> 
                                                                        <div align="center"><strong><font color="#333333">状态</font></strong></div></td>
                                                                           
                                                                      <td width="191"><div align="center"><strong><font color="#333333">网&nbsp;站&nbsp;名&nbsp;称</font></strong></div></td>
                                                                      <td width="70" bgcolor="EAECED"> 
                                                                        <div align="center"><strong><font color="#333333">登录时间</font></strong></div></td>
                                                                      <td width="51" bgcolor="EAECED"><div align="center"><strong><font color="#333333">修改</font></strong></div></td>
...
rs=stmt.executeQuery("SELECT * from unionbar order by id desc");
...
<%if(Integer.parseInt((String)rs.getString("ok"))==0){%><font color=red>未处理</font><%}else{%><%if(Integer.parseInt((String)rs.getString("tui"))==0){%>普通<%}else{%>推荐<%}%> <%}%>      </font></div></td>
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="../union/url.jsp?id=<%=rs.getString("id")%>" target="_blank" class="zllink"><font color="#333333">
...
<%=rs.getString("webname")%>
                                                                      ...
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="modiunion.jsp?id=<%=rs.getString("id")%>" class="zllink"><font color="#333333">修改</font></a></div></td>
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="delunion.jsp?id=<%=rs.getString("id")%>" class="zllink"><font color="#333333">删除</font></a></div></td>
                                                                    </tr>
...
<%
rs=stmt.executeQuery("SELECT count(*) from unionbar  order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="glunion.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
