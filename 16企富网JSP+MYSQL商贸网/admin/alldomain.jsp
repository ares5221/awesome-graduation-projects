...
<td class="zl"><strong><font color="#1F69A0">所有分配域名</font></strong>
</td>
</tr>
</table></td>
</tr>
                                                                ...
                                                                <form name="form1" method="post" action="cfsj.jsp">
                                                                  ...
                                                                  <table width="521" border="0" cellpadding="3" cellspacing="1" bgcolor="A8A8A9">
                                                                    <tr bgcolor="EAECED" class="zl"> 
                                                                      ...
                                                                      <td width="60"><div align="center"><strong><font color="#333333">域名</font></strong></div></td>
                                                                      <td width="191"><div align="center"><strong><font color="#333333">代理地区</font></strong></div></td>
...
<%if(Integer.parseInt((String)rs.getString("domainstatus"))==0){%><font color=red><a href=domainpei.jsp?id=<%=rs.getString("id")%>&domainstatus=1><font color=red>未分配</font></a></font><%}else{%><a href=domainpei.jsp?id=<%=rs.getString("id")%>&domainstatus=0>已分配</a><%}%>  
                                                                      ...
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="http://<%=rs.getString("domain")%>.qifo.com" target="_blank" class="zllink"><font color="#333333">
http://<font color=red><b><%=rs.getString("domain")%></b></font>.qifo.com
</font></a></div></td>
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="../www/index.jsp?id=<%=rs.getString("id")%>" target="_blank" class="zllink"><font color="#333333">
<%=rs.getString("sf")%><%=rs.getString("dldq")%>
</font></a></div></td>               
                                                                    </tr>
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="alldomain.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
