                                                    ...
                                                    <tr> 
                                                      <td><div align="center"> 
                                                          <table width="500" border="0" cellspacing="0" cellpadding="0">
                                                            <tr> 
                                                              <td height="24" bgcolor="E4E6E7"><table width="500" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr> 
                                                                    ...
                                                                    <td class="zl"><strong><font color="#1F69A0">修改代理资料</font></strong></td>
                                                                  </tr>
                                                                </table></td>
                                                            </tr>
                                                            <tr> 
                                                            ...
                                                            <tr> 
                                                              <td><form  action="modidlok.jsp" method="post" name="Form1"  >
...
<select name="sf" id="sf">
 ...
 <input name=dldq type="text" class="zl" id="dldq" size="30" value=<%=rs.getString("dldq")%>></td>
         ...
         <tr> 
                                                                      <td width="18%" height="35" bgcolor="#FFFFFF"> 
                                                                        <div align="center"><a href="#" class="zllink"><font color="444A4F">代理帐号</font></a>:<FONT color=red size=2>*</FONT></div></td>
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
 <input name=dlname type="text" class="zl" id="dlname" size="30" value=<%=rs.getString("dlname")%>></td>
                                                                    </tr>


         <tr> 
                                                                      <td width="18%" height="35" bgcolor="#FFFFFF"> 
                                                                        <div align="center"><a href="#" class="zllink"><font color="444A4F">代理密码</font></a>:<FONT color=red size=2>*</FONT></div></td>
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
 <input name=password type="text" class="zl" id="password" size="30" value=<%=rs.getString("password")%>></td>
                                                                    </tr>
         ...
         <tr> 
                                                                      ...
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
 <input name=letname type="text" class="zl" id="letname" size="30" value=<%=rs.getString("letname")%>></td>
                                                                    </tr>
 ...
 <input name=address type="text" class="zl" id="address" size="30" value=<%=rs.getString("address")%>></td>
         ...
         <tr> 
                                                                      <td width="18%" height="35" bgcolor="#FFFFFF"> 
                                                                        <div align="center"><a href="#" class="zllink"><font color="444A4F">邮政编码</font></a>:<FONT color=red size=2>*</FONT></div></td>
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
 <input name=post type="text" class="zl" id="post" size="30" value=<%=rs.getString("post")%>></td>
         ...
         <tr> 
                                                                      <td width="18%" height="35" bgcolor="#FFFFFF"> 
                                                                        <div align="center"><a href="#" class="zllink"><font color="444A4F">邮件地址</font></a>:<FONT color=red size=2>*</FONT></div></td>
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
 <input name=email type="text" class="zl" id="email" size="30" value=<%=rs.getString("email")%>></td>
                                                                    </tr>
         <tr> 
                                                                      <td width="18%" height="35" bgcolor="#FFFFFF"> 
                                                                        <div align="center"><a href="#" class="zllink"><font color="444A4F">QQ</font></a>:<FONT color=red size=2>*</FONT></div></td>
                                                                      <td colspan="2" bgcolor="#FFFFFF">&nbsp; 
 <input name=qq type="text" class="zl" id="qq" size="30" value=<%=rs.getString("qq")%>></td>
                                                                    </tr>
