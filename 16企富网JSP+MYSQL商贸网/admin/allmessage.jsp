...
<td class="zl"><strong><font color="#1F69A0">查看所有留言</font></strong>
</td>
</tr>
</table></td>
</tr>
                                                              ...
                                                              <td height="18" valign="top"> 
                                                                  ...
                                                                  <table width="521" border="0" cellpadding="3" cellspacing="1" bgcolor="A8A8A9">
                                                                    <tr bgcolor="EAECED" class="zl"> 
                                                                      ...
                                                                      <td width="191"><div align="center"><strong><font color="#333333">留言标题</font></strong></div></td>
...
rs=stmt.executeQuery("SELECT * from message  order by id desc");
...
%>
                                                                    ...
                                                                    <tr bgcolor="#FFFFFF"> 
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="showmsg.jsp?id=<%=rs.getString("id")%>" class="zllink"><font color="#333333">
...
<td class="zl"> 
                                                                      ...
                                                                      <td class="zl"><div align="center"><%if(Integer.parseInt((String)rs.getString("flag"))==0){%><font color=red>未读</font><%}else{%><font color=cccccc>已读</font><%}%></div></td>
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="delmemmsg.jsp?id=<%=rs.getString("id")%>" class="zllink"><font color="#333333">删除</font></a></div></td>
                                                                    </tr>
...
<%
rs=stmt.executeQuery("SELECT count(*) from message  order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="allmessage.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
