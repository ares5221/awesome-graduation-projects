...
<td class="zl"><strong><font color="#1F69A0">管理行业资讯</font></strong>
</td><td align=right><a href=addzixun.jsp>发布行业资讯</font></td>
</tr>
</table></td>
</tr>
<tr> 
                                                                ...
                                                                <form name="form1" method="post" action="cfsj.jsp">
                                                                  ...
                                                                  <table width="521" border="0" cellpadding="3" cellspacing="1" bgcolor="A8A8A9">
                                                                    <tr bgcolor="EAECED" class="zl"> 
                                                                      <td width="190"><div align="center"><strong><font color="#333333">标题</font></strong></div></td>
                                                                      <td width="60"><div align="center"><strong><font color="#333333">发布人</font></strong></div></td>
...
rs=stmt.executeQuery("SELECT * from zixun order by id desc");
...
%>
                                                                    ...
                                                                    <tr bgcolor="#FFFFFF"> 
                                                                      ...
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="../zixun/list.jsp?id=<%=rs.getString("id")%>" target="_blank" class="zllink"><font color="#333333">
<%=rs.getString("topic")%>
</font></a></div></td>
                                                                      <td class="zl"> 
...
<%=rs.getString("fbmem")%>
                                                                      ...
                                                                      <td class="zl"><div align="center"><a href="xgzixun.jsp?id=<%=rs.getString("id")%>" class="zllink"><font color="#333333">修改</font></a></div></td>
                                                                    
                                                                      <td class="zl"> 
                                                                        <div align="center"><a href="delzixun.jsp?id=<%=rs.getString("id")%>" class="zllink"><font color="#333333">删除</font></a></div></td>
                                                                    </tr>
...
<%
rs=stmt.executeQuery("SELECT count(*) from zixun order by id desc");
...
共<font color="#000000"><%=(i+20)/20%>页</font>&nbsp;&nbsp;当前为<font color="#000000">第</font><font color="#FF0000"><%=pageInt%></font><font color="#000000">页</font> &nbsp;&nbsp;转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="glzixun.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
                                                                                </font></div></td>
                                                                          </tr>
                                                                        </table></td>
                                                                    </tr>
