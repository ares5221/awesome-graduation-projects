                            ...
                            <table width="750" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td height="25"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td width="350" class="zl">产品列表共<font color="#FF0000"><%=(i+20)/20%></font>页 
                                        <%=i%>个展图 当前为第<%=pageInt%>页</td>
                                      <td valign="middle">
<div align="right"> 
                                          <p class="zl">
										  
									转到第&nbsp;<%for(int j=1;j<(i+40)/20;j++){%><a href="glshow.jsp?page=<%=j%>"><font color=red><%=j%></font></a>&nbsp;<%}%>页
