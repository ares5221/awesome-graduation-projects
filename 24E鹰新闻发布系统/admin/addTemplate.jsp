...
<form name="form1" method="post" action="./addTemplate.do">
  <table class="border" border="0" cellpadding="2" cellspacing="1" width="100%">
    <tbody>
      ...
      <tr class="tdbg"> 
        <td>&nbsp;&nbsp;<strong> 模板类型： </strong> <select name="templateType" id="templateType" >
            <c:forEach var="templateType" items="${type.coll}"> 
            <option value="<c:out value="${templateType.id}"/>"><c:out 
			value="${templateType.type}"/></option> 
			</c:forEach>
            <option value="0" selected>请选择模板类型</option>
          </select></td>
      </tr>
      <tr class="tdbg"> 
        <td>&nbsp;&nbsp;<strong> 模板名称： </strong> <input name="templateName" id="templateName" value="" size="50" maxlength="50" type="text"></td>
      </tr>
      <tr class="tdbg"> 
      ...
      <tr class="tdbg" id="showAlgebra"> 
        <td> <table>
            <tbody>
              <tr> 
                <td width="20"></td>
                <td><textarea name="content" rows="30" cols="128" wrap="OFF" id="content" class="body2" onmouseup="setcontent('get',1)"></textarea></td>
              </tr>
            </tbody>
          </table></td>
      </tr>
      ...
      <tr class="tdbg"> 
        <td align="center" height="50"><input name="ChannelID" id="ChannelID" value="1" type="hidden"> 
          <input name="action" id="action" value="newOne" type="hidden"> <input name="button" value=" 添 加 " onclick="return CheckForm(1);" type="button"> 
        </td>
      </tr>
    </tbody>
  </table>
