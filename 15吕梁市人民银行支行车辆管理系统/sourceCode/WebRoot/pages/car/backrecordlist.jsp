				...
				<tr>
					...
					<td width="100%">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3"
							...
							<tr bgcolor="#fff5d6" height="25"><th>派车单号</th><th>车辆类型</th><th>返车时间</th><th>费用</th><th>操作</th></tr>
							<tr>
								<td bgcolor="#cccccc"  height="3" colspan="5"></td>
							</tr>
								...
								<tr bgcolor="#e6ffd6" height="25">
									<td width="20%" align="center">${record.outid}</td>
										<td width="20%" align="center">
										${record.outrecord.motorcar.cartype}
									</td>
									<td width="20%" align="center">${record.backdate }</td>
									<td width="20%" align="center">
									${record.cost }
									</td>
									<td width="20%" align="center">
										<a href="../../lookBackRecordInfo.do?outid=${record.outid }">详细信息</a>
									</td>
								</tr>
								<tr>
								<td bgcolor="#cccccc"  height="3" colspan="5"></td>
