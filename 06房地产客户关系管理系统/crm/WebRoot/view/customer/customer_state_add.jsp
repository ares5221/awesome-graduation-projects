...
<html>
  <head>
	...
	<body>
		<form action="servlet/CustomerServlet?method=addcondition"  name="form2" onsubmit="return checkForm('form2');" method="post" >
			<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
				...
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"  maxlength="20" name="condition_Name"  check_str="顾客状态名称" >
						&nbsp;
					</td>
				</tr>
				<tr>
					...
					<td colspan="3" bgcolor="#FFFFFF">
						<input type="text"    name="condition_Explain">
						&nbsp;
					</td>
				</tr>
