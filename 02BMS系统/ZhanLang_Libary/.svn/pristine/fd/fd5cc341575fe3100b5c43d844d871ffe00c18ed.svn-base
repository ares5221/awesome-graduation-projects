...
public class M_ShowBorrowMessage extends JFrame {
	...
	public M_ShowBorrowMessage() {
		...
		biaoti.setFont(new Font("楷体", Font.BOLD, 14));
		biaoti.setBounds(10, 21, 863, 24);
		contentPane.add(biaoti);
		
		label = new JLabel("");
		label.setIcon(new ImageIcon(M_ShowBorrowMessage.class.getResource("/picture/text/显示借阅信息背景.jpg")));
		label.setBounds(0, 0, 884, 462);
		contentPane.add(label);
		//往框框里填被借出的书的信息
		biaoti.append("     编号\t书名\t作者\t出版社     \t借阅人\t入库时间\t\t借阅时间\t\t类型");
