...
<div class="page-container">
	<div class="text-c"><!--  指定查询日期：
		从<input type="text" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="datemin" class="input-text Wdate" style="width:120px;">
		到
		...
		<tbody>
			<c:forEach items="${kcList }" var="kc">
				<tr class="text-c">
					...
					<td class="td-manage">
					<a title="编辑" href="javascript:;" onclick="member_edit('库存价格调整','servlet/KuCunServlet?method=findStockById&id=${kc.id}','4','','510')"  class="ml-5" style="text-decoration:none">
