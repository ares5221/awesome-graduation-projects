...
%>
<jsp:useBean id="p_showitem" scope="page" class="firm.firm"/>
<%
    String itemID=request.getParameter("itemID");  
    String sql="select * from I_s_item where itemID='"+itemID+"'";
    ResultSet rs=p_showitem.executeQuery(sql);
	//定义数据类型并初始化
    ...
    if(rs.next())
	{
		...
		rs.close();
        p_showitem.closeStmt();
        p_showitem.closeConn();
	}
	...
	ResultSet rs2=p_showitem.executeQuery(sql2);
%>
                  ...
                  <td>                    
                    ...
                    <table width="95%" border="0" cellspacing="1" cellpadding="1" align="center">
                      ...
                      <tr> 
                        ...
                        <td bgcolor="#f2f2f2"><font color="#000099"> 
                      ...
                      <tr> 
                        ...
                        <td> <font color="#000099"><%=begin_year%>年<%=begin_month%>月——<%=finish_year%>年<%=finish_month%>月</font> 
                        </td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center"><font color="#000099">申请者</font></td>
                        <td><font color="#000099">&nbsp;<%=applicant1%>（<%=grade1%>）（<%=education1%>）</font></td>
                      </tr>
                      <tr> 
                    ...
                    <table width="95%" border="0" cellspacing="1" cellpadding="1" align="center">
                      ...
                      <tr> 
                        <td bgcolor="#d9d8dc" align="right" width="50%">&nbsp; 
                          &nbsp;&nbsp;<a href="p_mind.jsp?itemID=<%=itemID%>"><img src="../images/p_mind.gif" width="80" height="22" border="0"></a>&nbsp;</td>
                        <td bgcolor="#d9d8dc">&nbsp;
                          <INPUT onclick=javascript:window.print(); type=image src="../images/print1.gif" width="80" height="22">
                        </td>
                      </tr>
                    </table>
                  </td>
