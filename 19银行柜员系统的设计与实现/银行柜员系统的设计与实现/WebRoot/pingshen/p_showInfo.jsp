                ...
                <tr> 
                  <td> 
                    <table width="95%" border="0" cellspacing="1" cellpadding="1" align="center">
                      ...
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">身份证号</font></td>
                        <td bgcolor="#f2f2f2" colspan="2"><font color="#000099"><%=identityID1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">性&nbsp;&nbsp;&nbsp;&nbsp;别</font></td>
                        <td colspan="2"><font color="#000099"><%=sex1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">民&nbsp;&nbsp;&nbsp;&nbsp;族</font></td>
                        <td bgcolor="#f2f2f2" colspan="2"><font color="#000099"><%=nation1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"> <font color="#000099">出生日期</font></td>
                        <td colspan="2"><font color="#000099"><%=bir_year%>年<%=bir_month%>月<%=bir_day%>日</font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">单位代码</font></td>
                        <td colspan="2"><font color="#000099"><%=unit_ID1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">所在单位</font></td>
                        <td bgcolor="#f2f2f2" colspan="2"><font color="#000099"><%=unit_name1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">职&nbsp;&nbsp;&nbsp;&nbsp;称</font></td>
                        <td colspan="2"><font color="#000099"><%=grade1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">研究领域</font></td>
                        <td bgcolor="#f2f2f2" colspan="2"> <font color="#000099"><%=domain1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">适评专业</font></td>
                      ...
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">联系地址</font></td>
                        <td colspan="2"><font color="#000099"><%=address1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">邮政编码</font></td>
                        <td bgcolor="#f2f2f2" colspan="2"><font color="#000099"><%=zipcode1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">电&nbsp;&nbsp;&nbsp;&nbsp;话</font></td>
                        <td colspan="2"><font color="#000099"><%=tel1%></font></td>
                      </tr>
                      <tr> 
                        <td bgcolor="#d9d8dc" align="center" width="21%"><font color="#000099">简&nbsp;&nbsp;&nbsp;&nbsp;介</font></td>
