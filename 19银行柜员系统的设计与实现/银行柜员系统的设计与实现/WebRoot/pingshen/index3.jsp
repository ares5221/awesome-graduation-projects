...
function check(form){
    if (form.expert_name.value=="")
    { 
       alert("请输入姓名！");
       form.expert_name.focus();
       return false; 
     }
    ...
    <tr>
      <td height="139"> 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="22">
              <div align="center"><font color="#ffcc00" face="Wingdings">v</font><font color="#0010a0"><b>欢迎使用招标项目申报系统</b></font><font color="#ffcc00" face="Wingdings">v</font></div>
            </td>
          </tr>
        </table>
          ...
          <tr> 
            <td> 
              <div align="center">
				...
				<form name=form method=post action="p_checklogon.jsp" onsubmit="return check(this)">
                <table width="35%" border="0" cellspacing="0" cellpadding="0" height="138">
                  <tr>
                    <td height="175"> 
                      <table width="87%" border="0" cellspacing="1" cellpadding="0" height="154" bgcolor="#4f71b8">
                        <tr> 
                          <td height="100"> 
                              <table width="300" border="0" cellspacing="0" cellpadding="0" bgcolor="#F0F0F0" height="187">
                                <tr> 
                                  <td colspan="2" height="20" bgcolor="#4f71b8"> 
                                    <div align="center"><b><img src="../images/pingshen1.gif" ></b></div>
                                  </td>
                                </tr>
                                <tr> 
                                ...
                                <tr> 
                                  <td width="50%"> 
                                    <div align="center"><font color="#000099">专家姓名</font> 
                                    </div>
                                  </td>
                                  <td width="50%"> 
                  ...
                  size=12>
                                ...
                                <tr> 
                                  <td width="50%">
                                    <div align="center"><font color="#000099">身份证号</font></div>
                                  </td>
                                  <td width="50%">
                  ...
                  <tr>
                    <td height="5">
                        <div align="center"><font color="#ff0000">
                            <%
                                String getmessage=(String)session.getValue("p_logmessage");
