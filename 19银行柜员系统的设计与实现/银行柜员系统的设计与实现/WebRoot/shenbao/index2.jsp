          ...
          <tr> 
            <td> 
              <div align="center">
				...
				<form name=form method=post action="s_checklogon.jsp" onsubmit="return check(this)">
                          ...
                          <td height="100"> 
                              <table width="300" border="0" cellspacing="0" cellpadding="0" height="187" bgcolor="#F0F0F0">
                                ...
                                <td colspan="2" height="20" bgcolor="#4f71b8"> 
                                    <div align="center"><b><img src="../images/shenbao1.gif" ></b></div>
                                </td>
                              </tr>
                              <tr> 
                              ...
                              <tr> 
                                <td width="50%"> 
                                    <div align="center"><font color="#000099">单位代码</font> 
                                    </div>
                                </td>
                                <td width="50%"> 
                                  <input name=unit_ID 
