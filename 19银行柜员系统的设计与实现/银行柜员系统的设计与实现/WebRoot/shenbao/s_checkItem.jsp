...
<%
    ...
    ResultSet srs=s_checkItem.executeQuery(ssql);
...
<%
	...
	String sort[]={"",""};
	System.out.println("<<isort.length>>"+isort.length);
    ...
    String sql="update I_s_item set item_name='"+item_name+"',sort1='"+sort[0]+"',sort2='"+sort[1]+"',begin_date='"+begin_date+"',finish_date='"+finish_date+"',applicant='"+applicant+"',grade='"+grade+"',education='"+education+"',unit_name='"+unit_name+"',fill_date='"+fill_date+"',purport='"+purport+"',status='"+status+"',future='"+future+"',point='"+point+"',analysis='"+analysis+"',way='"+way+"',moment='"+moment+"',result='"+result+"',reference='"+reference+"',market='"+market+"',commend_mind='"+commend_mind+"' where itemID='"+itemID+"'";
    s_checkItem.executeUpdate(sql);

    String sql4="delete from I_s_money where itemID='"+itemID+"'";
    s_checkItem.executeUpdate(sql4);
    ...
    for(i=0;i<14;i++)
    {
	    ...
	    s_checkItem.executeUpdate(sql2);
        }
    }
