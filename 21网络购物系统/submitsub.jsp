...
<script>
  function openbag(id) { window.open("viewsub.jsp?sub_id="+id,"","height=400,width=600,left=190,top=0,resizable=yes,scrollbars=yes,status=no,toolbar=no,menubar=no,location=no");} 
</script><head>
<title>历史处理订单</title>
<link href=css.css rel=STYLESHEET type=text/css>
</head>
...
String sql;
sql="select * from sub where user_name='"+session.getValue("user_name")+"' and sub_check='true'";
ResultSet rs;
