...
<body>
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x" action="servlet/StudentServlet?method=rePassword">
				<div class="form-group">
					<div class="label">
						<label for="sitename">帐号：</label>
					</div>
					<div class="field" >
						<label style="line-height: 33px;"> ${user.sname } </label>
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<input type="password" class="input w50" id="mpass" name="mpass"
							...
							data-validate="required:请输入原始密码,length#>=3:原始密码不会小于3位" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
