  ...
  <body onLoad="clockon(bgclock)">
	...
	<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
	  ...
	  <tr align="center" bgcolor="#e3F4F7">
	    ...
	    <c:forEach items="${overdueBookList }" var="each">
	    	<tr>
			    <td style="padding:5px;">&nbsp;${each[0] }</td>
			    <td style="padding:5px;">&nbsp;${each[1] }</td>
			    <td style="padding:5px;">&nbsp;${each[2] }</td>
			    <td style="padding:5px;">&nbsp;${each[3] }</td>
			    <td style="padding:5px;">&nbsp;${each[4] }</td>
			    <td style="padding:5px;">&nbsp;${each[5] }</td>
	        </tr> 
	    </c:forEach>
