...
<td width="16%" align="right">
      <a href="ManagerPurview/addBookCase.jsp" >添加书架信息</a> </td>	  
  </tr>
</table>  
 ...
 <c:forEach items="${sxtPageUtil.list }" var="each">
  <tr>
    <td style="padding:5px;">${each.bcname }</td>
    
    <td align="center"><a href="ManagerServlet?operation=SelectoneBookc&&bcid=${each.bcid }" >修改</a></td>
    <td align="center"><a href="ManagerServlet?operation=deleoneBookc&&bcid=${each.bcid }">删除</a></td>
  </tr>
</c:forEach>
