...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：系统设置 &gt; 修改书架设置 &gt;&gt;&gt;</td>
      </tr>
      <tr>
        <td align="center" valign="top">
<form action="ManagerServlet" method="post">
	<input type="hidden" value="updectbookCase" name="operation">
	<input type="hidden" value="${book.bcid }" name="bcid">
  <table width="91%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr align="center" bgcolor="#e3F4F7">
    <td  >书架名称</td>
    <td>
	<input type="text" name="name" value="${book.bcname }">
	</td>
  </tr>
  	<tr>
