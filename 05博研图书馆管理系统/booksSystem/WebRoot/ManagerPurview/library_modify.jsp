...
<input type="hidden" name="operation" value="modifyLibrary">
<input type="hidden" name="lid" value="${library.lid }">
  ...
  <tr align="center">
    ...
    <td width="80%" align="left">
      <input name="libraryname" type="text" id="libraryname" value="${library.name }" size="30">
    
    </td>
    <tr>
    <td align="left" style="padding:5px;">馆长：</td>
    <td align="left"><input name="curator" type="text" id="curator" size="30" value="${library.liber}"" ></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left"><input name="address" type="text" id="address" size="30" value="${library.addr }"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left"><input name="createDate" type="text" id="createDate" size="30" value="${library.creatdate }"">
      (日期格式：2007-11-22)</td>
    </tr>
    <tr>
      <td height="84" align="left" style="padding:5px;">图书馆简介：</td>
      <td align="left"><textarea name="introduce" cols="50" rows="5" class="wenbenkuang" id="introduce">${library.intro }"</textarea></td>
    </tr>
    <tr>
