					              ...
					              <tr>
					               	 <td width="2%">&nbsp;</td>
						                  <td width="97%" align="center" valign="top">
							                    <form method="post" action="AdminServlet1">
							                    <input type="hidden" name="operation" value="login">
							                      ...
							                      <td width="31%">
							                        <input name="uname" type="text" class="logininput" id="name" size="27"><span id="spanname" style="color:red">${msg }</span>                        </td>
							                      <td width="9%">&nbsp;</td>
							                    </tr>
							                        <tr>
							                          <td height="37">&nbsp;</td>
							                      ...
							                      <td colspan="2" align="center"><input name="Submit" type="submit" class="btn_grey" value="确定" onClick="return check(form1)">
							                        ...
							                        <input name="Submit2" type="submit" class="btn_grey" value="关闭" onClick="window.close();"></td>
							                      <td>&nbsp;</td>
							                    </tr>
							                        </table> 
										        </form>				   
