...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="87%">&nbsp;      </td>
<td width="13%">
      <a href="reader/addreader.jsp">添加读者信息</a></td>	  
  </tr>
</table>  
 ...
 <c:forEach items="${sxtPageUtil.list }" var="each">
  <tr>
    <td style="padding:5px;">${each.barcode }</td>  
    <td style="padding:5px;">${each.name }</td>
    <td style="padding:5px;">${each.readerType.name }</td>
    <td align="center">${each.paperType }</td>
   
    <td align="center">${each.tel}</td>
    <td align="center">${each.email} ${each.rid}</td>
    <td align="center"><a href="ReaderServlect?operation=updectRead&&rid=${each.rid}">修改</a></td>
