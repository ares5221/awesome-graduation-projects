...
<form action="ReaderServlect" method="post">
    <input type="hidden" name="operation" value="updectReaderType">
    <input type="hidden" name="id" value="${readerType.id }">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    ...
    <input type="text" name="name" value="${readerType.name }">
    </td>
    </tr>
     <tr align="center" bgcolor="#e3F4F7">
    <td width="35%" bgcolor="#F9D16B">可借数量</td>
   <td> 
   <input type="text" name="number" value="${readerType.number }">
   </td>
    </tr>
    <tr>
