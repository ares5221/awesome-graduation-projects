...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <table width="91%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="right">      
      <a href="reader/readerTypeAdd.jsp" >添加读者类型信息</a> </td>
</tr>
</table>  
...
<c:forEach items="${readerType }" var="each">
  <tr>
    <td style="padding:5px;">${each.name }</td>
    <td style="padding:5px;">&nbsp;${each.number }</td>
    <td align="center"><a href="ReaderServlect?operation=selectoneReaderType&&id=${each.id }" >修改</a></td>
    <td align="center"><a href="ReaderServlect?operation=deltAllReader&&id=${each.id }">删除</a></td>
  </tr>
  </c:forEach>
</table></td>
      </tr>
